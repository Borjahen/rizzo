...
function ProviderLogoUrbanAdventures(_ref) {
  var className = _ref.className,
      style = _ref.style;

  return _react2.default.createElement(_icon.LogoUrbanAdventuresColor, {
...
exports.default = ProviderLogoUrbanAdventures;