...
var uploader_1 = require("../classes/uploader"); // Stand up s3 and base variables
...
var libDir = "lib"; // Create an instance of the uploader

var uploader = new uploader_1.S3Uploader(); // Grab built files from the lib directory

var files = glob.sync(libDir + "/**/*.?(css|html|js|map)"); // Generate a list of keys and contents to upload
...
Promise.all(promises.concat([uploader.upload({
  key: componentsKey,
  body: componentsBody
      ...
      switch (_a.label) {
        case 0:
          ...
          purges = keys.concat([[componentsKey]]).map(function (_a) {
            var key = _a[0];
            var url = "https://assets.staticlp.com/" + key; // tslint:disable-next-line:no-console
        ...
        case 2:
          messages = _a.sent();
          oks = messages.filter(function (m) {
            return m.status === "ok";
          }).length; // tslint:disable-next-line:no-console
