...
var imgix_1 = require("../../helpers/imgix");

describe("imgix", function () {
  describe("booking.com", function () {
    it("should replace aff.bstatic.com", function () {
      var result = imgix_1.default("https://aff.bstatic.com/images/hotel/max500/177/1778356.jpg", {}, "bdc");
    ...
    it("should replace q-xx.bstatic.com", function () {
      var result = imgix_1.default("https://q-xx.bstatic.com/images/hotel/max500/177/1778356.jpg", {}, "bdc");
      expect(result).toEqual("https://lpbookingcom.imgix.net/images/hotel/max500/177/1778356.jpg");
    });
  });
  describe("gadventures", function () {
    it("should replace media.gadventures.com", function () {
      var result = imgix_1.default("https://media.gadventures.com/media-server/cache/e2/7a/e27ad55d69b8cea10baac7f50e526a16.jpg", {}, "gadventures");
  ...
  describe("hostelworld", function () {
    it("should replace ucd.hwstatic.com", function () {
      var result = imgix_1.default("https://ucd.hwstatic.com/propertyimages/7/76525/1.jpg", {}, "hostelworld");
  ...
  describe("media", function () {
    it("should replace media.lonelyplanet.com", function () {
      var result = imgix_1.default("https://media.lonelyplanet.com/foo.jpg", {}, "media");
  ...
  describe("news", function () {
    it("should replace lonelyplanet.com/news/wp-content/uploads", function () {
      var result = imgix_1.default("https://www.lonelyplanet.com/news/wp-content/uploads/foo.jpg", {}, "news");
  ...
  describe("staticAsset", function () {
    it("should replace s3.amazonaws.com/static-asset", function () {
      var result = imgix_1.default("https://s3.amazonaws.com/static-asset/op-video-sync/images/production/foo.jpg", {}, "staticAsset");
  ...
  describe("staticSites", function () {
    it("should replace s3.amazonaws.com/lp-static-sites", function () {
      var result = imgix_1.default("https://s3.amazonaws.com/lp-static-sites/trinity-college-dublin/assets/images/foo.jpg", {}, "staticSites");
  ...
  describe("viator", function () {
    it("should replace cache-graphicslib.viator.com", function () {
      var result = imgix_1.default("https://cache-graphicslib.viator.com/graphicslib/thumbs674x446/26200/SITours/nashville-food-and-sightseeing-tour-in-nashville-309998.jpg", {}, "viator");
  ...
  describe("wordpress", function () {
    it("should replace lonelyplanet.com/travel-blog/tip-article/wordpress_uploads", function () {
      var result = imgix_1.default("https://www.lonelyplanet.com/travel-blog/tip-article/wordpress_uploads/foo.jpg", {}, "wordpress");
      expect(result).toEqual("https://lonelyplanetwp.imgix.net/foo.jpg");
    });
  });
  describe("with parameters", function () {
    it("should add params to the url", function () {
      var result = imgix_1.default("http://media.lonelyplanet.com/foo.jpg", {
        w: 1024,
        h: 768
      }, "media");
  ...
  describe("non-matching url", function () {
    it("should return the original url", function () {
      var result = imgix_1.default("http://www.anotherurl.com/foo.jpg");
  ...
  describe("without source", function () {
    it("should handle an undefined source", function () {
      var result = imgix_1.default("https://media.lonelyplanet.com/foo.jpg", {});
      expect(result).toEqual("https://lonelyplanetimages.imgix.net/foo.jpg");
    });
    it("should handle a null string source", function () {
      var result = imgix_1.default("https://media.lonelyplanet.com/foo.jpg", {}, null);
      expect(result).toEqual("https://lonelyplanetimages.imgix.net/foo.jpg");
    });
    it("should handle a mismatched source key", function () {
      var result = imgix_1.default("https://media.lonelyplanet.com/foo.jpg", {}, "notakey");
