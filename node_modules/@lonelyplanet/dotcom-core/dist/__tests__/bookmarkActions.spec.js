...
describe("bookmark actions", function () {
  ...
  it("should add an item to a list", function () {
    ...
    var thunk = bookmark_1.addBookmarkToList({
      userId: "1234",
      listId: "5678",
      data: {
        checked: true,
  ...
  it("should update a bookmark", function () {
    ...
    var thunk = bookmark_1.updateBookmark({
      userId: "1234",
      listId: "5678",
      entryId: "999",
      data: {
  ...
  it("should handle errors updating a bookmark", function () {
    ...
    thunk(dispatch, function () {
      ...
      var showToast = dispatch.mock.calls[1][0];
      showToast(dispatch);
  ...
  it("should dispatch error messages", function () {
