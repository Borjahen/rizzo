...
var mapper_1 = require("../resources/video/mapper");
describe("VideoMapper", function () {
    it("correctly maps a video to a video model", function () {
    ...
    it("correctly maps included video sources", function () {
        var mapper = new mapper_1.default();
        var resource = {
            "type": "video",
            "id": "520",
        ...
        var model = mapper.toModel(resource, included);
