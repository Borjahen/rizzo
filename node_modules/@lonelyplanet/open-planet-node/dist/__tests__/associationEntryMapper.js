...
var mapper_1 = require("../resources/associationEntry/mapper");
describe("AssociationEntryMapper", function () {
    it("should map an association-entry to an associationEntry model", function () {
    ...
    it("properly assigns target to the an association-entry model", function () {
        var mapper = new mapper_1.default();
        var model = mapper.toModel({
            "type": "association-entry",
            "relationships": {
