...
var host = "http://connect.lonelyplanet.com";
var redirectUri = "/sso";
describe("auth", function () {
    it("should fetch an access token", function () { return __awaiter(_this, void 0, void 0, function () {
        var mockFetch, auth, token;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    mockFetch = jest.fn(function () { return new Promise((function (resolve) { return resolve({
    ...
    it("should have scopes", function () {
        expect(scopes_1.userSelfAll).toMatchSnapshot();
    });
});
