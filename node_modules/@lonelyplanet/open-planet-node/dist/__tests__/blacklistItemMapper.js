...
var mapper_1 = require("../resources/blacklistItem/mapper");
describe("BlacklistItemMapper", function () {
    it("should map an blacklist item to a blacklist item model", function () {
    ...
    it("properly assigns target to the a blacklist item model", function () {
        var mapper = new mapper_1.default();
        var model = mapper.toModel({
            "type": "blacklist-item",
            "relationships": {
