...
var service_1 = require("../resources/associationEntry/service");
var associationEntry_1 = require("../resources/associationEntry");
describe("AssociationEntryService", function () {
    it("should fetch an association entry by given id", function () {
        ...
        service.findByEntryId("123", "c41e0fde-5e64-11e8-b625-2fe248649608")
            .then(function (associationEntry) {
    ...
    it("should create an association entry with given attributes", function () {
        var fetchMock = jest.fn(function () { return new Promise((function (resolve) { return resolve({
            data: {
                attributes: {
                    "matches_source": true,
        ...
        var entry = new associationEntry_1.default({
            "matchesSource": true,
            "target": {
                id: "351223",
                type: "poi"
        ...
        service.createAssociationEntry("123", entry).then(function (result) {
    ...
    it("should bulk insert association entries", function () {
        var fetchMock = jest.fn(function () { return new Promise((function (resolve) { return resolve({
            data: [
                {
                    attributes: {
        ...
        var entries = [
            new associationEntry_1.default({
                "matchesSource": true,
                "target": {
                    id: "1234",
                    type: "place"
        ...
        service.bulkInsert("123", entries).then(function (entries) {
    ...
    it("should delete an association entry with given id", function () {
        var fetchMock = jest.fn(function () { return new Promise((function (resolve) { return resolve({
            data: {}
        }); })); });
        var service = new service_1.default("access123");
