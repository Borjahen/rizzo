...
export declare type openPlanetResourceTypes = "place" | "narrative" | "thorntree-topic" | "poi" | "lodging";
...
export interface IResourceMapper<T, R> {
    ...
    toModel(resource: R, included: any): T;
    toResource(model: T): R;
}
export interface IJsonApiResource<T = {
    [key: string]: any;
}, R extends IJsonApiRelationships = {
...
export interface IAuthRequestBuilder {
    buildUrl(queryObject: any): string;
    getLoginUrl(authMethod: any, redirect: any, settings: any): string;
    getRefreshUrl(authMethod: any, redirect: any, settings: any): string;
...
export declare type priceRange = "top-end" | "mid-range" | "budget";
