...
var PoiMapper = /** @class */ (function (_super) {
    ...
    PoiMapper.prototype.toModel = function (resource, included) {
        ...
        model.alternative_names = attrs.alternative_names;
        ...
        var associations = included.filter(function (resource) {
            return resource.type === image_1.imageAssociationType &&
                model.id === resource.relationships.to.data.id;
        })
            .map(function (a) { return a.relationships.from.data.id; });
        if (associations) {
            ...
            model.images = images.map(function (image) { return ({
                ...
                url: imgix_1.default(image.links.pixels, "media"),
            }); });
        }
        return model;
    };
