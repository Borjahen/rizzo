import TagAssociationMapper from "../resources/tagAssociation/mapper";
import {ITagAssociation} from "../resources/tagAssociation/index";

describe("TagAssociationMapper", () => {
  it("should map an tag association to a tag model", () => {
    const mapper = new TagAssociationMapper();

    const model: ITagAssociation = mapper.toModel({
  ...
  it("properly assigns target to the a tag association model", () => {
    const mapper = new TagAssociationMapper();
