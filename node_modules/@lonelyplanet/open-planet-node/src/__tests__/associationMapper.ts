import AssociationMapper from "../resources/association/mapper";
import {IAssociation} from "../resources/association/index";

describe("AssociationMapper", () => {
  it("should map an association to an association model", () => {
    const mapper = new AssociationMapper();

    const model: IAssociation = mapper.toModel({
      "type": "association",
      "relationships": {},
  ...
  it("properly assigns source to the association model", () => {
    const mapper = new AssociationMapper();
  ...
  it("properly assigns entries to the association model", () => {
    const mapper = new AssociationMapper();
  ...
  it("properly assigns suggestions to the association model", () => {
    const mapper = new AssociationMapper();
