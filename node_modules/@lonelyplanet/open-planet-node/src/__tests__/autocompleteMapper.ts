import AutocompleteMapper from "../resources/search/autocomplete/mapper";

describe("AutocompleteMapper", () => {
  it("should map a search result to an autocomplete model", () => {
    const mapper = new AutocompleteMapper();
