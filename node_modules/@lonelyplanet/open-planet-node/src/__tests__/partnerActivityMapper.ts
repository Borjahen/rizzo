import PartnerActivityMapper from "../resources/partnerActivity/mapper";
import { IPoi } from "../resources/poi";

describe("PartnerActivityMapper", () => {
  it("should map a partner activity entry to a partner activity model", () => {
    const mapper = new PartnerActivityMapper();
