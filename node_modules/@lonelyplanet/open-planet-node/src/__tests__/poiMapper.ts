import PoiMapper from "../resources/poi/mapper";

describe("PoiMapper", () => {
  it("should map a POI entry to a POI model", () => {
    const mapper = new PoiMapper();
    ...
    const model = mapper.toModel(
      ...
      [
        ...
        },
        {
          ...
          attributes: {
            path:
              "/a/g/hi/t/d1f3f73703867dfd0c11f047927181e6-country-music-hall-of-fame-museum.jpg"
          },
          type: "image",
          links: {
            pixels:
              "https://media.lonelyplanet.com/a/g/hi/t/d1f3f73703867dfd0c11f047927181e6-country-music-hall-of-fame-museum.jpg",
            self: "/images/9999"
          }
        },
        {
    ...
    expect(model.images[0].path).toBe(
      "/a/g/hi/t/d1f3f73703867dfd0c11f047927181e6-country-music-hall-of-fame-museum.jpg"
    );
    expect(model.images[0].url).toBe(
      "https://lonelyplanetimages.imgix.net/a/g/hi/t/d1f3f73703867dfd0c11f047927181e6-country-music-hall-of-fame-museum.jpg"
    );
  });
});
