import BookmarkPopularityService from "../resources/bookmarkPopularity/service";

describe("BookmarkPopularityService", () => {
  it("should fetch a bookmark popularity given place id", () => {
    ...
    const service = new BookmarkPopularityService("access123");
    service.http = {
      fetch: fetchMock,
    };
  ...
  it("should fetch a bookmark popularity given target type", () => {
    const fetchMock = jest.fn(() => new Promise((resolve => resolve({
      "data": [
        {
          "type": "bookmark-popularity",
