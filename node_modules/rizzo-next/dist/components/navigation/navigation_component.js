...
var _helpers = require("@lonelyplanet/dotcom-core/dist/helpers");
...
var userAvatarTemplate = require("./user_avatar.hbs");
var signOutLinkTemplate = require("./sign_out_link.hbs");
var avatarMarkerTemplate = require("./avatar_marker.hbs");
var profileSettingsButtonTemplate = require("./profile_settings_button.hbs");
var thornTreeLinkTemplate = require("./thorn_tree_link.hbs");
...
var NavigationComponent = (_dec = (0, _subscribe2.default)("user.status.update"), _dec2 = (0, _subscribe2.default)("user.notifications.update"), (_class = function (_Component) {
  ...
  _createClass(NavigationComponent, [{
    ...
    value: function updateShopUrl() {
      var shopUrl = this.state.cartItemCount ? this.cartUrl : "https://shop.lonelyplanet.com/";
    ...
    value: function userStatusUpdate(user) {
      ...
      var $mobileNavigationHeader = this.$mobileNavigation.find(".js-mobile-navigation-header");
    ...
    key: "buildLegacyAuthUrl",
    value: function buildLegacyAuthUrl() {
      var windowExists = typeof window !== "undefined";

      var _authSetupWithDefault = (0, _helpers.authSetupWithDefaults)(windowExists && window.lp.auth),
          builder = _authSetupWithDefault.builder;

      var targetLinkUri = windowExists && window.location.origin + window.location.pathname;
