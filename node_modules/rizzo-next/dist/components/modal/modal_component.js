...
var _lpAnalytics = require("@lonelyplanet/lp-analytics");
...
var Modal = function (_Component) {
  ...
  _createClass(Modal, [{
    ...
    value: function initialize(options) {
      this.track = (0, _lpAnalytics.getTrackMethod)();
      this.events = {
        "touchend a": "goTo"
      };
    ...
    value: function handleSubmitSuccess(e) {
       ...
       */
      this.track(_defineProperty({}, _lpAnalytics.analytics.eventName, _lpAnalytics.EventNames.newsletterSubscription));
    }
  }, {
    key: "submit",
