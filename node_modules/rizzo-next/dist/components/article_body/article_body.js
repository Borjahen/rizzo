...
var ArticleBodyComponent = function (_Component) {
  ...
  _createClass(ArticleBodyComponent, [{
    ...
    value: function loadVideos() {
      this.$el.find("[data-op-video-id]").addClass("is-visible").each(function (i, el) {
        _video2.default.addPlayer(el, {
          insertPixel: false,
          playsInline: true
        }).then(function (player) {
          var description = player.getVideoProperty("description") || "";
          (0, _jquery2.default)(player.videoEl).after("<span class=\"copy--caption\">" + description + "</span>");
        });
      });
    }
