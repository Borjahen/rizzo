  ...
  _createClass(ImageGalleryComponent, [{
    ...
    value: function initialize() {
      var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
          ...
          _ref$autoplayVideos = _ref.autoplayVideos,
          autoplayVideos = _ref$autoplayVideos === undefined ? true : _ref$autoplayVideos;
    ...
    value: function _parseThumbnailElements() {
      ...
      this.$images.each(function (i, el) {
        var $galleryImage = (0, _jquery2.default)(el),
            ...
            youtubeID = _video2.default.getYoutubeId(link),
            brightcoveID = _video2.default.getBrightcoveId(link);
    ...
    key: "_videoPlay",
    value: function _videoPlay(galleryItem) {
      this._videoStop();
      if (galleryItem.videoID) {
        _video2.default.addPlayer(galleryItem.videoID, { type: galleryItem.videoType,
